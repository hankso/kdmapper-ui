...
Download [release for Windows](https://github.com/hankso/kdmapper-ui/releases/latest)

## Alternates

A Python UI depends on only built-in modules is provided under [GUI](./GUI) directory.

```bash
# you can package with nuitka
python -m pip install nuitka

cd GUI
cp ../x64/Release/kdmapper_Release.exe kdmapper.exe
cp ../HelloWorld.sys ./
python -m nuitka kdmapper_ui.py  # -> ./build/kdmapper_ui.exe
```
...
MFC GUI written by https://github.com/hankso
